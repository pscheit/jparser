<?php
/**
 * File containing class JFinallyClauseNode
 * @author Tim Whitlock
 * @category PLUG
 * @package JavaScript
 * @subpackage JNodes
 * @version $Id: JFinallyClauseNode.php,v 1.1 2009/03/22 12:51:08 twhitlock Exp $
 */
 
 
/**
 * JavaScript node class for the J_FINALLY_CLAUSE symbol
 * @category PLUG
 * @package JavaScript
 * @subpackage JNodes
 */
