...
/**
 * File containing class JObjectLiteralNode
 * @author Tim Whitlock
 * @category PLUG
 * @package JavaScript
 * @subpackage JNodes
 * @version $Id: JObjectLiteralNode.php,v 1.1 2009/03/22 12:51:09 twhitlock Exp $
 */

use PLUG\JavaScript\JNodes\JNodeBase;

/**
 * JavaScript node class for the J_OBJECT_LITERAL symbol
 * @category PLUG
 * @package JavaScript
 * @subpackage JNodes
 */
