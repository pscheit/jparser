...
/**
 * File containing class JCatchClauseNode
 * @author Tim Whitlock
 * @category PLUG
 * @package JavaScript
 * @subpackage JNodes
 * @version $Id: JCatchClauseNode.php,v 1.1 2009/03/22 12:51:08 twhitlock Exp $
 */

use PLUG\JavaScript\JNodes\JNodeBase;

/**
 * JavaScript node class for the J_CATCH_CLAUSE symbol
 * @category PLUG
 * @package JavaScript
 * @subpackage JNodes
 */
